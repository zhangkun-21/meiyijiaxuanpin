...
export interface PerformancePrediction {
  // Counts
  delistCount: number          // 下架商品数
  listCount: number            // 上架商品数
  // Calculated from actual data
  delistSales: number          // 下架商品原90天销售额
  listSales: number            // 上架商品90天销售额
...
export async function predictPerformance(
  ...
  // Separate adopted delist vs adopted list items based on type flag
